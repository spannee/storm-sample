...
import com.axisrooms.storm.bolt.KafkaMessengerBolt;
...
public class KafkaTopology {
    ...
    public static void main(String[] args) throws InvalidTopologyException, AuthorizationException, AlreadyAliveException {
        ...
        builder.setBolt(Constants.KAFKA_MESSENGER_BOLT, new KafkaMessengerBolt(), 1).shuffleGrouping(Constants.KAFKA_SPOUT);
