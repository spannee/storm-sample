...
@Slf4j
public class DaywiseInventoryBolt implements IRichBolt {
    ...
    public void execute(Tuple tuple) {
        ...
        /*try {
            responseCode = APIUtil.redirectPost(jsonString, Constants.CM_BASE_URL, Constants.DAYWISE_INVENTORY_EP);
